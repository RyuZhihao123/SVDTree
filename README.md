...
• [**Zhihao Liu**](https://ryuzhihao123.github.io/): mainly handles the **``Shape-guided 3D Tree Modeling``** (3D Graphics part), which takes **voxels (point clouds)** as input and produces the final realistic 3D tree models. 
