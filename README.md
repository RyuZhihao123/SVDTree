...
• ⭐ **This is a NEW version: [[a more advanced point-based 3D tree reconstruction software]](https://github.com/RyuZhihao123/Point-cloud-3D-tree-reconstruction).** It's more powerful than this project so we suggest also trying that new tool.
